...
public class kaziehsanulmubin_task01 implements GLEventListener{
	 private GLU glu;
	   @Override
	   public void display(GLAutoDrawable drawable) {
	      ...
	      convertToZone0(gl, 10,50,10,0);
	      convertToZone0(gl, -10,50,-10,0);
	      convertToZone0(gl, -30,50,-10,50);
	      convertToZone0(gl, -30,25,-10,25);
	      convertToZone0(gl, -30,50,-30,25);
	      convertToZone0(gl, -30,0,-10,0);	  
	   ...
	   public static void main(String[] args) {
	      ...
	      kaziehsanulmubin_task01 l = new kaziehsanulmubin_task01();
